 ...
 #ourstory{
  ...
  <div class="site-wrap"  id="home-section">
    ...
    <img src="/images/logo2.png" alt="logo" style="width:40px;">
            ...
            <a href="#" class="text-white"><span class="mr-2 text-white icon-phone"></span> <span class="d-none d-md-inline-block"> Intern Management Portal </span></a>
            

            <div class="float-right">
             <a href="#" class="dropdown-toggle text-white" data-toggle="dropdown" > <span class="d-none d-md-inline-block" >Sign up </span></a> 
            <ul class="dropdown-menu">
          <li><a href="/register">as Company</a></li>
          <li><a href="/uni">as university</a></li>
        </ul>
      </li>  
            <span class="mx-md-2 d-inline-block"></span>
           
            <a href="/login" class="text-white"> <span class="d-none d-md-inline-block">Login</span></a>
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
           ...
           <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                ...
                <li><a href="/publicannou" class="nav-link" id="announcment">Announcments</a></li> 
                
                <li><a href="#about-section" class="nav-link">Our Story </a></li>
      ...
      <div class="container">
        <div class="row justify-content-center mb-4 block-img-video-1-wrap">
          <div class="col-md-12 mb-5">
           ...
           <p>We believe that we can help other students to face the problems we have gone through. So we created the IMP to help students find the intership programs opportunities they desire.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-6 col-md-6 mb-4 col-lg-0 col-lg-3" data-aos="fade-up" data-aos-delay="300">
                <div class="block-counter-1">
                  ...
                  <span class="caption">Number of Companies</span>
                </div>
              </div>
            </div>
          </div>
